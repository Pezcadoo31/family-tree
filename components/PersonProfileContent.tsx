...
// the floating modal. Keep this file's JSX in sync with itself only — both
// callers just pass data, so there is nothing else to keep in sync with.
// ============================================================================

export function PersonProfileContent({ person, relationships, petRelationships }: Props) {
